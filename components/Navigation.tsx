      ...
      <div className="px-2 xs:px-3 sm:px-4 md:px-6 py-2 sm:py-3 flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center space-x-4 xl:space-x-6">
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="px-4 xl:px-6 py-2 bg-gradient-to-r from-accent to-highlight text-black font-semibold text-sm xl:text-base
              rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 
              flex items-center space-x-1.5 xl:space-x-2 backdrop-blur-sm whitespace-nowrap"
          >
